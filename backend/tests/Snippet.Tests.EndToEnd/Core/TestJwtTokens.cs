...
/// These tokens are issued by Clerk for testing purposes and have extended expiration dates.
/// </summary>
public static class TestJwtTokens
{
    /// <summary>
    /// JWT token for a test user with admin/manager permissions across all modules.
