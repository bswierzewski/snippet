...
export const createCreateCollection = <TError = Error[], TContext = unknown>(
	options?: {
		mutation?: CreateMutationOptions<
			Awaited<ReturnType<typeof createCollection>>,
			TError,
...
export const getGetUserCollectionsQueryOptions = <
	...
	TError = Error[]
>(options?: {
	query?: Partial<CreateQueryOptions<Awaited<ReturnType<typeof getUserCollections>>, TError, TData>>;
}) => {
...
export function createGetUserCollections<TData = Awaited<ReturnType<typeof getUserCollections>>, TError = Error[]>(
	options?: { query?: Partial<CreateQueryOptions<Awaited<ReturnType<typeof getUserCollections>>, TError, TData>> },
	queryClient?: QueryClient
...
>(
	id: string,
	options?: { query?: Partial<CreateQueryOptions<Awaited<ReturnType<typeof getCollectionById>>, TError, TData>> }
) => {
	const { query: queryOptions } = options ?? {};
...
export function createGetCollectionById<TData = Awaited<ReturnType<typeof getCollectionById>>, TError = Error[]>(
	id: string,
	options?: { query?: Partial<CreateQueryOptions<Awaited<ReturnType<typeof getCollectionById>>, TError, TData>> },
	queryClient?: QueryClient
): CreateQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> } {
...
export const createUpdateCollection = <TError = Error[], TContext = unknown>(
	options?: {
		mutation?: CreateMutationOptions<
			Awaited<ReturnType<typeof updateCollection>>,
			TError,
...
export const getDeleteCollectionMutationOptions = <TError = Error[], TContext = unknown>(options?: {
	mutation?: CreateMutationOptions<Awaited<ReturnType<typeof deleteCollection>>, TError, { id: string }, TContext>;
}): CreateMutationOptions<Awaited<ReturnType<typeof deleteCollection>>, TError, { id: string }, TContext> => {
...
export const createDeleteCollection = <TError = Error[], TContext = unknown>(
	options?: {
		mutation?: CreateMutationOptions<Awaited<ReturnType<typeof deleteCollection>>, TError, { id: string }, TContext>;
	},
	queryClient?: QueryClient
): CreateMutationResult<Awaited<ReturnType<typeof deleteCollection>>, TError, { id: string }, TContext> => {
